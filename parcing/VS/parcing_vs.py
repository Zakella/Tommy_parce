...
def get_data(cat_name, url):
    ...
    for item in stacks:
        for list_item in item.get("list"):
            # if list_item.get('url') == "/us/beauty/beauty-catalog/5000006635?brand=vs&collectionId=053b3ce9-e70f-4ca4-a3db-5f8500eb16ed&limit=180&priceType=regular&productId=2551a17b-e21e-4904-b3e5-f158b329401c&stackId=1793680b-4df9-4837-b2ee-48c187417d76&genericId=11169023&choice=3872":
            #     print(items_list)
            item_card = {}
